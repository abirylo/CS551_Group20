...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 33 = access	*/
	do_get,		/* 34 = getgroups */
	do_AuthSuperUser,		/* 35 = do_AuthSuperUser	*/
	no_sys,		/* 36 = sync	*/
	do_kill,	/* 37 = kill	*/
	no_sys,		/* 38 = rename	*/
	no_sys,		/* 39 = mkdir	*/
	...
	no_sys,		/* 55 = fcntl	*/
	no_sys,		/* 57 = unused	*/
	do_AddGroupLeader,		/* 56 = do_AddGroupLeader  */
	do_IGInit,		/* 58 = unused	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	...
	do_IGLookup,		/* 69 = unused	*/
	do_IGCreate,		/* 70 = unused	*/
	...
	no_sys,		/* 95 = (fchmod) */
	no_sys,		/* 96 = (fchown) */
	do_RemoveGroupLeader,		/* 97 = do_RemoveGroupLeader */
	...
	do_AddGroupLeader,		/* 103 = unused */
	do_getprocnr,	/* 104 = getprocnr */
	no_sys,		/* 105 = unused */
	do_get,		/* 106 = issetugid */
	do_getepinfo_o,	/* 107 = getepinfo XXX: old implementation*/
	do_IGSubscriber,		/* 108 = unused */ /* added */
	do_IGPublish,		/* 109 = unused */ /* added */
	do_IGRetrive,		/* 110 = unused */ /* added */
